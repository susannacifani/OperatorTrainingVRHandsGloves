...
namespace SG
{
    ...
    public class SG_HandTrackingExample : MonoBehaviour
    {
        ...
        public static void UpdateJoints(SG_HandPose handPose, Transform[] joints)
        {
            ...
            Debug.Log("wirst : " + positions[0]);
            Debug.Log("Thumb CMC : " + positions[1]);
            Debug.Log("Thumb MCP : " + positions[2]);
            Debug.Log("Thumb IP : " + positions[3]);
            Debug.Log("Thumb Tip : " + positions[4]);
